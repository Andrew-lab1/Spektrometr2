...
#define CLIP_ENCODING_H265    2 /* Compressed using h265 encoding */
...
#define FEATURE_PTP                     41
#define FEATURE_LIGHTING                42
#define FEATURE_COMPRESSION             43
#define FEATURES_TOTAL                  44
...
#define FEATURE_BLACK_LEVEL_OFFSET      FEATURE_BRIGHTNESS         /* Sensor Black Level Offset is controlled via Brightness */
#define FEATURE_PRECISION_TIME_PROTOCOL FEATURE_PTP               /* For those that prefer the longer, more descriptive name */
...
/* Pixel formats with an 'alpha' channel */
#define PIXEL_FORMAT_RGBA   35
#define PIXEL_FORMAT_BGRA   36
#define PIXEL_FORMAT_ARGB   37
#define PIXEL_FORMAT_ABGR   38
...
#define PFNC_RGBa8             PIXEL_FORMAT_RGBA
#define PFNC_BGRa8             PIXEL_FORMAT_BGRA
#define PFNC_aRGB8             PIXEL_FORMAT_ARGB
#define PFNC_aBGR8             PIXEL_FORMAT_ABGR
...
/* Frame Buffer Policy - Controls frame buffering behavior, defining the frame that will be returned via PxLGetNextFrame  */
#define FBP_NEXT_AVAILABLE   0  /* PxLGetNextFrame will return the next frame to arrive at the host */
#define FBP_OLDEST_AVAILABLE 1  /* PxLGetNextFrame will return the oldest available undelivered frame */
#define FBP_DEFAULT          FBP_NEXT_AVAILABLE
...
#define TRIGGER_TYPE_LINE1                TRIGGER_TYPE_HARDWARE
#define TRIGGER_TYPE_ACTION               3
#define TRIGGER_TYPE_LINE2                4
#define TRIGGER_TYPE_LINE3                5
#define TRIGGER_TYPE_LINE4                6

/* Returns TRUE if the trigger type is a hardware trigger */
#define IS_HARDWARE_TRIGGER(triggerType) ( ((triggerType) == TRIGGER_TYPE_LINE1) ||  \
                                           ((triggerType) == TRIGGER_TYPE_LINE2) ||  \
                                           ((triggerType) == TRIGGER_TYPE_LINE3) ||  \
                                           ((triggerType) == TRIGGER_TYPE_LINE4) )
...
typedef struct _CONTROLLER_INFO
{
    ...
    BOOL32 USBVirtualPort;         // TRUE if this is a Virtual COM port over USB
    char   VendorName [64];
    char   ModelName [64];
...
typedef struct _FRAME_DESC
{
    ...
    struct {
       float  fCompressionStrategy;    /* Type of compression used (0 == no compression) */
       float  fCompressedSize;         /* Total number of bytes in the compressed image (or image size if uncompressed) */
    } CompressionInfo;  /* Compression information for this specific PixelFormat.fValue */

} FRAME_DESC, *PFRAME_DESC;

typedef struct _COMPRESSION_DESC COMPRESSION_DESC, *PCOMPRESSION_DESC;
#define PIXELINK10_COMPRESSION_DESC_SIZE 40 /* Number of bytes in a Pixelink10 compression descriptor */

/* Compression info used for callbacks of type CALLBACK_COMPRESSED_FRAME. */
typedef struct _COMPRESSION_INFO COMPRESSION_INFO, *PCOMPRESSION_INFO;
/* Compression info specifically for FEATURE_COMPRESSION_STRATEGY_PIXELINK10 compression streams */
...
#define CALLBACK_COMPRESSED_FRAME 0x20
...
#define OVERLAY_COMPRESSED_FRAME  CALLBACK_COMPRESSED_FRAME
...
typedef struct _CAMERA_ID_INFO
{
    ...
    U32              CameraLinkSpeed;      /* Speed of the camera's link, in Megabits/second */
...
#define GPIO_MODE_ACTION_STROBE    6
#define GPIO_MODE_ACTION_NORMAL    7
#define GPIO_MODE_ACTION_PULSE     8
#define GPIO_MODE_HARDWARE_TRIGGER 9
...
#define FEATURE_SPECIAL_CAMERA_MODE_FIXED_FRAME_RATE  1 /* Deprecated in some cameras */
...
/* FEATURE_PTP */
#define FEATURE_PTP_PARAM_MODE            0
#define FEATURE_PTP_PARAM_STATUS          1
#define FEATURE_PTP_PARAM_ACCURACY        2
#define FEATURE_PTP_PARAM_OFFSET_FROM_MASTER    3
#define FEATURE_PTP_NUM_PARAMS            4

/* FEATURE_PTP_PARAM_MODE Values */
#define FEATURE_PTP_MODE_DISABLED         0  /* PTP is disabled */
#define FEATURE_PTP_MODE_AUTOMATIC        1  /* PTP state machine is running (see STATUS) */
#define FEATURE_PTP_MODE_SLAVE_ONLY       2  /* PTP state machine prevented from achieving MASTER */

/* FEATURE_PTP_PARAM_STATUS Values */
#define FEATURE_PTP_STATUS_INITIALIZING   1
#define FEATURE_PTP_STATUS_FAULTY         2
#define FEATURE_PTP_STATUS_DISABLED       3
#define FEATURE_PTP_STATUS_LISTENING      4
#define FEATURE_PTP_STATUS_PREMASTER      5
#define FEATURE_PTP_STATUS_MASTER         6
#define FEATURE_PTP_STATUS_PASSIVE        7 /* Not used */
#define FEATURE_PTP_STATUS_UNCALIBRATED   8
#define FEATURE_PTP_STATUS_SLAVE          9

/* FEATURE_LIGHTING */
#define FEATURE_LIGHTING_PARAM_BRIGHTNESS  0
#define FEATURE_LIGHTING_PARAM_CURRENT     1
#define FEATURE_LIGHTING_PARAM_VOLTAGE     2
#define FEATURE_LIGHTING_PARAM_TEMPERATURE 3
#define FEATURE_LIGHTING_NUM_PARAMS        4

/* FEATURE_COMPRESSION */
#define FEATURE_COMPRESSION_PARAM_PIXEL_FORMAT 0
#define FEATURE_COMPRESSION_PARAM_STRATEGY     1

#define FEATURE_COMPRESSION_STRATEGY_NONE       0   /* No Compression*/
#define FEATURE_COMPRESSION_STRATEGY_PIXELINK10 1   /* Pixelink10 - proprietary lossless compression for MONO8 */
...
#define EVENT_ANY                        0 
#define EVENT_CAMERA_DISCONNECTED        1
#define EVENT_HW_TRIGGER_RISING_EDGE     2
#define EVENT_HW_TRIGGER_FALLING_EDGE    3
#define EVENT_GPI_RISING_EDGE            4
#define EVENT_GPI_FALLING_EDGE           5
#define EVENT_HW_TRIGGER_MISSED          6
#define EVENT_SYNCHRONIZED_TO_MASTER     7
#define EVENT_UNSYNCHRONIZED_FROM_MASTER 8
#define EVENT_FRAMES_SKIPPED             9
#define EVENT_SENSOR_SYNCHRONIZED        10
#define EVENT_LAST                       EVENT_SENSOR_SYNCHRONIZED

#define ACTION_FRAME_TRIGGER             0
#define ACTION_GPO1                      1
#define ACTION_GPO2                      2
#define ACTION_GPO3                      3
#define ACTION_GPO4                      4
#define ACTION_SENSOR_SYNC               5
#define ACTION_LAST                      ACTION_SENSOR_SYNC
